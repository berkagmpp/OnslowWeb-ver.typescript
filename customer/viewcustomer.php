...
if ($rowcount > 0) {
    echo "<fieldset><legend>customer detail #$id</legend><dl><br>";
    $row = mysqli_fetch_assoc($result);
    echo "<dt>First name:</dt><dd>" . $row['firstname'] . "</dd><br>";
    echo "<dt>Last name:</dt><dd>" . $row['lastname'] . "</dd><br>";
    echo "<dt>Email:</dt><dd>" . $row['email'] . "</dd><br>";
    echo "<dt>Password:</dt><dd>" . $row['password'] . "</dd><br>";
    echo '</dl></fieldset><br>';
